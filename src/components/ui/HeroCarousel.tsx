    ...
    <div className="relative w-full h-[450px] md:h-[600px] lg:h-[80vh] min-h-[450px] overflow-hidden">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#1a0f16] via-[#1a0f16]/60 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#1a0f16]/80 via-transparent to-transparent" />
        </motion.div>
      </AnimatePresence>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-[14px] md:text-body-m line-clamp-2 md:line-clamp-3 text-white/70">
                {items[currentIndex].description || "An epic journey continues. Join the adventure now."}
              </p>
